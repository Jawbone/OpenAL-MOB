...
#define NEW_AUDIO_COMPONENT ( 1 || TARGET_OS_IPHONE ) // MRG: Mac OS 10.8 has depricated the old way of doing things, so 
// we should do the the same way as iOS

#if NEW_AUDIO_COMPONENT
#include <AudioToolbox/AudioToolbox.h>
#include <AudioToolbox/AudioServices.h>
#include <CoreFoundation/CoreFoundation.h>
#else // #if NEW_AUDIO_COMPONENT
#include <CoreServices/CoreServices.h>
#endif  // #else // #if NEW_AUDIO_COMPONENT
#include <unistd.h>
...
static ALCboolean ca_reset_playback(ALCdevice *device)
{
    ...
    switch(streamFormat.mChannelsPerFrame)
    {
        ...
        case 8:
            ...
            break;
        default:
            ERR("Unhandled channel count (%d), using Stereo\n", (int)streamFormat.mChannelsPerFrame);
            device->FmtChans = DevFmtStereo;
